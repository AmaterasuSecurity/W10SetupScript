Start-Job -Name "Install and Configure Chocolatey" -ScriptBlock {
  ...
  Start-Job -Name "Installing Browsers" -Scriptblock {
    ...
    Start-Job -Name "Installing WSL" -Scriptblock {
        Write-Host "Installing WSL"
        choco install wsl-ubuntu-2204
    }

    Start-Job -Name "Installing Coding Software" -ScriptBlock {
        Write-Host "Installing Coding Software"
        choco install vscode vscode-powershell
    }

    Start-Job -Name "Installing Drivers" -ScriptBlock {
        Write-Host "Installing Drivers"
        choco install nvidia-display-driver geforce-experience geforce-game-ready-driver 
    }
...
<#     Write-Host "Installing Gaming Software"
    choco install steam epicgameslauncher minecraft #>



    Write-Host "Installing Virtualization Software"
    choco install vmware-workstation-player vmware-tools
    ...
    choco install 7zip.install streamdeck streamdeck-streamlabs  greenshot
  }
